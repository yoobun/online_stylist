...
def get_suggestions_for_expansion(likes, styles):
    gpt_prompt = "I like to wear "+likes+" and "+styles+" styles. What are some style suggestions? Give me 5 suggestions like this: 1. [suggestions] 2. [suggestion] 3. [suggestion]" 
    print(gpt_prompt)
...
def get_brands_list():
    ...
    # Printing the string representation of the JSON object
    print(json_string)
...
def suggestions():
    return render_template('style_suggestions', data=style_data)
